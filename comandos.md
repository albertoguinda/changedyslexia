...
Desarrollo
bashnpm run dev                  # Ecosistema completo (5 apps)
...
Apps Individuales
bashnpm run dev:api             # API Symfony (puerto 8000)
...
Build y Deployment
bashnpm run build              # Build frontend + juegos
...
Mantenimiento
bashnpm run clean              # Limpiar deps + builds
...
Desarrollo
bashnpm run test               # Tests en todos los workspaces
